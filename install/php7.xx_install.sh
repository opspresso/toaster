...
[[ ! -f php-7.0.17.tar.bz2 ]] && \
    wget https://s3.ap-northeast-2.amazonaws.com/repo.yanolja.com/php/php-7.0.17.tar.bz2

tar xfp php-7.0.17.tar.bz2
cd php-7.0.17
...
rm -f $_MAIN/php_5.ini


echo -ne "\n\n
#################################
 PHP-7.0.17 Install success
#################################
\n\n"